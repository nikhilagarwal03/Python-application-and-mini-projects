...
Create a Python script that takes a message and adds emojis after specific keywords to
...
# getting message a input 
message = input("Enter your message text here: ")
